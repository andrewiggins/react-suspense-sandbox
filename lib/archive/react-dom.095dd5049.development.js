...
/**
 * Set certain methods to default to collapsed in the
 * console window
...
class MethodTracer {
  ...
  enter(name, idParam) {
    ...
    const methodConfig = MethodTracerConfig[name];
  ...
  unwindOnError(error, name, idParam) {
    ...
    this.console.log('Error caught in "' + this.lastId() + '". Rewinding to "' + id + '"');
