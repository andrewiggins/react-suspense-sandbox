    ...
    case ClassComponentLazy:
      {
        if (finishedWork.effectTag & Snapshot) {
          if (current$$1 !== null) {
            ...
            ReactTracer.log('getSnapshotBeforeUpdate', getComponentName(finishedWork.type));
    ...
    case ClassComponentLazy:
      {
        ...
        if (finishedWork.effectTag & Update) {
          if (current$$1 === null) {
            ...
            ReactTracer.log('componentDidMount', getComponentName(finishedWork.type));
            ...
            ReactTracer.log('componentDidUpdate', getComponentName(finishedWork.type));
        ...
        if (updateQueue !== null) {
          ...
          ReactTracer.log('commitUpdateQueue', getComponentName(finishedWork.type));
...
function commitAttachRef(finishedWork) {
  ReactTracer.log('commitAttachRef', getComponentName(finishedWork.type));
...
function commitAllLifeCycles(finishedRoot, committedExpirationTime) {
  ReactTracer.enter('commitAllLifeCycles');
...
function completeUnitOfWork(workInProgress) {
  ReactTracer.enter('completeUnitOfWork', getComponentName(workInProgress.type));

  // Attempt to complete the current unit of work, then move to the
  // next sibling. If there are no more siblings, return to the
  // parent fiber.
  while (true) {
    ReactTracer.log('Completing', getComponentName(workInProgress.type));
...
function performUnitOfWork(workInProgress) {
  ReactTracer.enter('performUnitOfWork', getComponentName(workInProgress.type));
