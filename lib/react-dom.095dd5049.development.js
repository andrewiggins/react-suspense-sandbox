...
function commitAllHostEffects() {
  ...
  while (nextEffect !== null) {
    ...
    const getDisplayName = fiber => typeof fiber.type === "function" ? fiber.type.name : fiber.type.toString();
      ...
      case PlacementAndUpdate:
        {
          ...
          console.group('commitWork - ' + getDisplayName(nextEffect));
          commitWork(_current, nextEffect);
          console.groupEnd('commitWork - ' + getDisplayName(nextEffect));
          break;
        }
      case Update:
        {
