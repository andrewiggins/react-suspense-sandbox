...

{
  ...
  {
    InvalidNestedHooksDispatcherOnRerenderInDEV.getCacheForType =
      getCacheForType;
...
function beginWork(current, workInProgress, renderLanes) {
  ...
  if (current !== null) {
    ...
    if (
      ...
      ReactTracer.log('no pending work - bailing out of subtree');
...
function renderRootSync(root, lanes) {
  ...
  do {
    try {
      ...
      ReactTracer.unwindOnError(thrownValue, 'renderRootSync', expirationTime);
...
ReactDOMRoot.prototype.unmount = ReactDOMLegacyRoot.prototype.unmount =
  function () {
    {
