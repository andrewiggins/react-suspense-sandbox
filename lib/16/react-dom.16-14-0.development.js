...
var ReactInternals = __SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;
...
var invokeGuardedCallbackImpl = invokeGuardedCallbackProd; // Disable the dev complexity in invokeGuardedCallbackDev
...
var ReactInternals$1 = __SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;
...
var ReactInternals$2 = __SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;
...
function dispatchEvent(
	...
	ReactTracer.enter('dispatchEvent', domEventName); // TODO: replaying capture phase events is currently broken
...
function commitPlacement(finishedWork) {
	ReactTracer.enter('commitPlacement', getComponentNameFromFiber(finishedWork)); // Recursively insert all host nodes into the parent.
...
function performConcurrentWorkOnRoot(root) {
	ReactTracer.enter('performConcurrentWorkOnRoot'); // Since we know we're in a React event, we can clear the current
...
export {
	...
	runWithPriority$2 as unstable_runWithPriority,
