...
let REACT_ELEMENT_TYPE$1 = 0xeac7;
let REACT_PORTAL_TYPE$1 = 0xeaca;
let REACT_FRAGMENT_TYPE$1 = 0xeacb;
...
let REACT_LAZY_TYPE$1 = 0xead4;
let REACT_DEBUG_TRACING_MODE_TYPE$1 = 0xeae1;
let REACT_OFFSCREEN_TYPE$1 = 0xeae2;
let REACT_LEGACY_HIDDEN_TYPE$1 = 0xeae3;
let REACT_CACHE_TYPE$1 = 0xeae4;

if (typeof Symbol === "function" && Symbol.for) {
  const symbolFor = Symbol.for;
  REACT_ELEMENT_TYPE$1 = symbolFor("react.element");
  REACT_PORTAL_TYPE$1 = symbolFor("react.portal");
  REACT_FRAGMENT_TYPE$1 = symbolFor("react.fragment");
  ...
  REACT_LAZY_TYPE$1 = symbolFor("react.lazy");
  REACT_DEBUG_TRACING_MODE_TYPE$1 = symbolFor("react.debug_trace_mode");
  REACT_OFFSCREEN_TYPE$1 = symbolFor("react.offscreen");
  REACT_LEGACY_HIDDEN_TYPE$1 = symbolFor("react.legacy_hidden");
  REACT_CACHE_TYPE$1 = symbolFor("react.cache");
}

const MAYBE_ITERATOR_SYMBOL$1 = typeof Symbol === "function" && Symbol.iterator;
const FAUX_ITERATOR_SYMBOL$1 = "@@iterator";
function getIteratorFn$1(maybeIterable) {
  ...
  const maybeIterator =
    ...
    maybeIterable[FAUX_ITERATOR_SYMBOL$1];
...
const _assign$1 = function (to, from) {
...
var assign =
  ...
  function (target, sources) {
    ...
    for (let nextIndex = 1; nextIndex < arguments.length; nextIndex++) {
      ...
      if (nextSource != null) {
        _assign$1(to, Object(nextSource));
      }
    }
...
Component.prototype.setState = function (partialState, callback) {
  if (
    ...
    {
      throw Error(formatProdErrorMessage$1(85));
    }
  }
...
const isArrayImpl$1 = Array.isArray; // eslint-disable-next-line no-redeclare

function isArray$1(a) {
  return isArrayImpl$1(a);
}
...
function createElement$1(type, config, children) {
  ...
  if (config != null) {
    ...
    for (propName in config) {
      if (
        hasOwnProperty$1$1.call(config, propName) &&
...
function cloneElement(element, config, children) {
  if (!!(element === null || element === undefined)) {
    {
      throw Error(formatProdErrorMessage$1(267, element));
    }
  }
...
function mapIntoArray(children, array, escapedPrefix, nameSoFar, callback) {
  ...
  if (isArray$1(children)) {
    ...
    const iteratorFn = getIteratorFn$1(children);
...
function onlyChild(children) {
  if (!isValidElement(children)) {
    {
      throw Error(formatProdErrorMessage$1(143));
    }
  }
...
function getCacheForType$1(resourceType) {
...
function useMutableSource$1(source, getSnapshot, subscribe) {
  const dispatcher = resolveDispatcher();
 ...
 */
const ReactCurrentBatchConfig$4 = {
  transition: 0,
};
...
var currentPriorityLevel = NormalPriority$1; // This is set while performing work, to prevent re-entrance.
...
const unstable_requestPaint$1 = requestPaint$1;
...
var Scheduler = {
  ...
  unstable_scheduleCallback: unstable_scheduleCallback$1,
  unstable_cancelCallback: unstable_cancelCallback$1,
  unstable_wrapCallback: unstable_wrapCallback,
  unstable_getCurrentPriorityLevel: unstable_getCurrentPriorityLevel$1,
  unstable_shouldYield: shouldYieldToHost,
  unstable_requestPaint: unstable_requestPaint$1,
...
const ReactSharedInternals$1 = {
  ...
  ReactCurrentOwner,
  ReactCurrentBatchConfig: ReactCurrentBatchConfig$4,
...
function startTransition$1(scope) {
  const prevTransition = ReactCurrentBatchConfig$4.transition;
  ReactCurrentBatchConfig$4.transition = 1;

  try {
    scope();
  } finally {
    ReactCurrentBatchConfig$4.transition = prevTransition;
  }
}
...
function act(callback) {
  {
    {
      {
        throw Error(formatProdErrorMessage$1(406));
      }
    }
  }
}

const createElement$1$1 = createElement$1;
...
const React = /*#__PURE__*/ Object.freeze({
  ...
  Component: Component,
  get Fragment() {
    return REACT_FRAGMENT_TYPE$1;
  },
  get Profiler() {
    return REACT_PROFILER_TYPE$1;
  },
  PureComponent: PureComponent,
  get StrictMode() {
    return REACT_STRICT_MODE_TYPE$1;
  },
  get Suspense() {
    return REACT_SUSPENSE_TYPE$1;
  },
  get SuspenseList() {
    return REACT_SUSPENSE_LIST_TYPE$1;
  },
  ...
  get unstable_Cache() {
    return REACT_CACHE_TYPE$1;
  },
  get unstable_DebugTracingMode() {
    return REACT_DEBUG_TRACING_MODE_TYPE$1;
  },
  get unstable_LegacyHidden() {
    return REACT_LEGACY_HIDDEN_TYPE$1;
  },
  get unstable_Offscreen() {
    return REACT_OFFSCREEN_TYPE$1;
  },
  unstable_act: act,
  unstable_createMutableSource: createMutableSource,
  unstable_getCacheForType: getCacheForType$1,
  unstable_useCacheRefresh: useCacheRefresh,
  unstable_useMutableSource: useMutableSource$1,
...
const ReactInternals = ReactSharedInternals$1;
var _assign = ReactInternals.assign;

const ReactSharedInternals = ReactSharedInternals$1;
...
let invokeGuardedCallbackImpl = invokeGuardedCallbackProd; // Disable the dev complexity in invokeGuardedCallbackDev
...
const ReactInternals$1 = ReactSharedInternals$1;
...
const unstable_getCurrentPriorityLevel =
...
_ReactInternals$Sched.unstable_yieldValue;
...
function commitUpdate(
  ...
  ReactTracer.log("commitUpdate", domElement, updatePayload); // Update the props handle so that we know which props are the ones with
...
const getLabelForLane$1 = getLabelForLane;
const TotalLanes$1 = TotalLanes;
/**
...
function getLaneLabels() {
  if (laneLabels.length === 0) {
    ...
    for (let index = 0; index < TotalLanes$1; index++) {
...
function markComponentRenderStarted(fiber) {
  {
    if (supportsUserTimingV3) {
      const componentName = getComponentNameFromFiber(fiber) || "Unknown"; // TODO (scheduling profiler) Add component stack id
...
function markComponentSuspended(fiber, wakeable, lanes) {
  {
    if (supportsUserTimingV3) {
      ...
      const phase = fiber.alternate === null ? "mount" : "update"; // TODO (scheduling profiler) Add component stack id
...
function getCacheForType(resourceType) {
  ...
  let cacheForType = cache.get(resourceType);
...
function updateCacheComponent(current, workInProgress, renderLanes) {
  ...
  if (current === null) {
    ...
    const freshCache = requestCacheFromPool();
    const initialState = {
      parent: parentCache,
      cache: freshCache,
    };
    ...
    case HostRoot: {
      {
        ...
        popRootCachePool(root, renderLanes);
        interruptedWork.memoizedState.cache;
        popCacheProvider();
      }
...
function getHookFlagLabel(flags) {
  return [
    (flags & Passive$1) == Passive$1 && "Passive",
...
function commitMutationEffectsOnFiber(finishedWork, root) {
  ...
  switch (primaryFlags) {
    case Placement: {
      ...
      ReactTracer.exit(); // Clear the "placement" from effect tag so that we know that this is
...
let pendingPassiveProfilerEffects = []; // Use these to prevent an infinite loop of nested updates
...
function completeUnitOfWork(unitOfWork) {
  ...
  do {
    ReactTracer.log("completing", getComponentNameFromFiber(completedWork)); // The current, flushed, state of this fiber is the alternate. Ideally
    // nothing should rely on this, but relying on it here means that we don't
    // need an additional field on the work in progress.
...
function retryTimedOutBoundary(boundaryFiber, retryLane) {
  ReactTracer.enter("retryTimedOutBoundary", suspendedTime); // The boundary fiber (a Suspense component or SuspenseList component)
...
export {
  Component as C,
  PureComponent as P,
  ReactSharedInternals$1 as R,
  useEffect as a,
  useLayoutEffect as b,
  useCallback as c,
  createElement$1$1 as d,
  REACT_FRAGMENT_TYPE$1 as e,
  createContext as f,
  React as g,
  useMemo as h,
  createRoot as i,
